...
def dummy_data():
    ...
    return data 
def test_transformers_classification_training(dummy_data, tmp_path):
    ## coco conversion
    ...
    image_object = read_pickle(tmp_image_object_storage)
    kfold = KFCV(output_path=tmp_path_folds, data_object=image_object, n_splits=2, log_dir="logs")
    kfold.kfold_cv()
